...
module.exports = {
  ...
  caption : process.env.CAPTION || "𝙵𝙸𝙻𝙴 𝙶𝙴𝙽𝙴𝚁𝙰𝚃𝙴𝙳 𝙱𝚈 EVONE X ＭＤ🚩" , // ```『 ²⁴ ᴠᴇɴᴏᴄʏʙᴇʀ-ᴍᴅ 』```", //*『ᴠᴇɴᴏᴄʏʙᴇʀ ᴍᴅ』*\n youtube.com/@JASTINMTEWA-vn9pl"),
 
  author : process.env.PACK_AUTHER|| "𝙴𝚅𝙾𝙽𝙴 𝚇 ",
  packname: process.env.PACK_NAME || "♥️",
  botname : process.env.BOT_NAME  || "𝐄𝐕𝐎𝐍𝐄 𝐗 𝐌𝐃",
  ownername:process.env.OWNER_NAME|| "It's 𝙳𝚊𝚛𝚊𝚢𝚊",
